...
gate rxx(_gate_p_0) _gate_q_0, _gate_q_1 {
  ...
  rz(0.5040000000000001) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  h _gate_q_1;
  h _gate_q_0;
}
...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(3.0240000000000014, 0, pi/2) _gate_q_0;
...
gate unitary_0 _gate_q_0, _gate_q_1 {
  ...
  U(1.7825814382375589, 2.049402714712879, -2.3925163822321327) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_3 _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(2.016, 0, pi/2) _gate_q_0;
  U(1.8302813584604818, 2.0910610861395913, -2.4823634584507754) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_4 _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(1.6295926535897929, 0, pi/2) _gate_q_0;
  U(2.0088428600514043, 2.1979592775616723, -2.7739080986373974) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(0.5040000000000001) q[1], q[2];
rzz(0.5040000000000001) q[1], q[2];
rzz(0.5040000000000001) q[1], q[2];
rxx(0.5040000000000001) q[0], q[1];
rzz(0.5040000000000001) q[0], q[1];
rxx(0.5040000000000001) q[2], q[3];
rxx(0.5040000000000001) q[1], q[2];
rxx(0.5040000000000001) q[1], q[2];
rzz(0.5040000000000001) q[0], q[1];
rzz(0.5040000000000001) q[2], q[3];
rxx(0.5040000000000001) q[1], q[2];
rxx(0.5040000000000001) q[2], q[3];
rzz(0.5040000000000001) q[1], q[2];
rxx(0.5040000000000001) q[0], q[1];
