...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.6360781000394666, 1.8509186885684024, -2.0259782895040104) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(4.4399999999999995) q[1], q[2];
rzz(4.4399999999999995) q[1], q[2];
rzz(4.4399999999999995) q[1], q[2];
rxx(4.4399999999999995) q[0], q[1];
rzz(4.4399999999999995) q[0], q[1];
rxx(4.4399999999999995) q[2], q[3];
unitary q[1], q[2];
rzz(4.4399999999999995) q[0], q[1];
rzz(4.4399999999999995) q[2], q[3];
c[0] = measure q[0];
