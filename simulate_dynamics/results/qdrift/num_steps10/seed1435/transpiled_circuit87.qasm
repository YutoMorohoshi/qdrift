...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.834344971728763, 2.094296130959626, -2.4896785103011316) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(5.279999999999999) q[1], q[2];
rzz(5.279999999999999) q[1], q[2];
rzz(5.279999999999999) q[1], q[2];
rxx(5.279999999999999) q[0], q[1];
rzz(5.279999999999999) q[0], q[1];
rxx(5.279999999999999) q[2], q[3];
unitary q[1], q[2];
rzz(5.279999999999999) q[0], q[1];
rzz(5.279999999999999) q[2], q[3];
c[0] = measure q[0];
