...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.9064773024254198, 2.144852268568343, -2.612970240810122) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(2.2199999999999998) q[1], q[2];
rzz(2.2199999999999998) q[1], q[2];
rzz(2.2199999999999998) q[1], q[2];
rxx(2.2199999999999998) q[0], q[1];
rzz(2.2199999999999998) q[0], q[1];
rxx(2.2199999999999998) q[2], q[3];
unitary q[1], q[2];
rzz(2.2199999999999998) q[0], q[1];
rzz(2.2199999999999998) q[2], q[3];
c[0] = measure q[0];
