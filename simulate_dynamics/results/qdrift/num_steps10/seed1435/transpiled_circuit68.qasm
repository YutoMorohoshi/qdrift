...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.8384000664002031, 2.097479486138348, -2.4969322611018097) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(4.140000000000001) q[1], q[2];
rzz(4.140000000000001) q[1], q[2];
rzz(4.140000000000001) q[1], q[2];
rxx(4.140000000000001) q[0], q[1];
rzz(4.140000000000001) q[0], q[1];
rxx(4.140000000000001) q[2], q[3];
unitary q[1], q[2];
rzz(4.140000000000001) q[0], q[1];
rzz(4.140000000000001) q[2], q[3];
c[0] = measure q[0];
