...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.5932260248171026, 1.7374609372015506, -1.837747269001932) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(3.3000000000000003) q[1], q[2];
rzz(3.3000000000000003) q[1], q[2];
rzz(3.3000000000000003) q[1], q[2];
rxx(3.3000000000000003) q[0], q[1];
rzz(3.3000000000000003) q[0], q[1];
rxx(3.3000000000000003) q[2], q[3];
unitary q[1], q[2];
rzz(3.3000000000000003) q[0], q[1];
rzz(3.3000000000000003) q[2], q[3];
c[0] = measure q[0];
