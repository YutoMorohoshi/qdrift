...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.946906848570003, 2.1681965196376716, -2.677961541930692) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(4.0200000000000005) q[1], q[2];
rzz(4.0200000000000005) q[1], q[2];
rzz(4.0200000000000005) q[1], q[2];
rxx(4.0200000000000005) q[0], q[1];
rzz(4.0200000000000005) q[0], q[1];
rxx(4.0200000000000005) q[2], q[3];
unitary q[1], q[2];
rzz(4.0200000000000005) q[0], q[1];
rzz(4.0200000000000005) q[2], q[3];
c[0] = measure q[0];
