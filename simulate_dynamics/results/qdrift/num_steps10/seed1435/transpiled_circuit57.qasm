...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.6702970530364951, 1.9124883671093356, -2.1327263270302828) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(3.4800000000000004) q[1], q[2];
rzz(3.4800000000000004) q[1], q[2];
rzz(3.4800000000000004) q[1], q[2];
rxx(3.4800000000000004) q[0], q[1];
rzz(3.4800000000000004) q[0], q[1];
rxx(3.4800000000000004) q[2], q[3];
unitary q[1], q[2];
rzz(3.4800000000000004) q[0], q[1];
rzz(3.4800000000000004) q[2], q[3];
c[0] = measure q[0];
