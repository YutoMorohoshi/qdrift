...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.8435394207568683, 2.1014507759144676, -2.5060616654617034) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(3.7199999999999998) q[1], q[2];
rzz(3.7199999999999998) q[1], q[2];
rzz(3.7199999999999998) q[1], q[2];
rxx(3.7199999999999998) q[0], q[1];
rzz(3.7199999999999998) q[0], q[1];
rxx(3.7199999999999998) q[2], q[3];
unitary q[1], q[2];
rzz(3.7199999999999998) q[0], q[1];
rzz(3.7199999999999998) q[2], q[3];
c[0] = measure q[0];
