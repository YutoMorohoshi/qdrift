...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.6389233503546088, 1.8566730171447539, -2.035784074322633) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(3.4200000000000004) q[1], q[2];
rzz(3.4200000000000004) q[1], q[2];
rzz(3.4200000000000004) q[1], q[2];
rxx(3.4200000000000004) q[0], q[1];
rzz(3.4200000000000004) q[0], q[1];
rxx(3.4200000000000004) q[2], q[3];
unitary q[1], q[2];
rzz(3.4200000000000004) q[0], q[1];
rzz(3.4200000000000004) q[2], q[3];
c[0] = measure q[0];
