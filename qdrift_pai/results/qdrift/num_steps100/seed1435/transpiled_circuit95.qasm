...
gate rxx(_gate_p_0) _gate_q_0, _gate_q_1 {
  ...
  rz(0.28800000000000003) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  h _gate_q_1;
  h _gate_q_0;
}
...
gate unitary_3 _gate_q_0, _gate_q_1 {
  ...
  U(pi/2, 0, 2.5802058126763807) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(2.5655926535897935, 0, pi/2) _gate_q_0;
...
gate unitary_5 _gate_q_0, _gate_q_1 {
  ...
  U(0.5613868409134123, pi/2, pi/2) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(2.277592653589793, 0, pi/2) _gate_q_0;
  U(1.7294596299700447, 1.993229905720785, -2.2809096087627285) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(0.28800000000000003) q[1], q[2];
rzz(0.28800000000000003) q[1], q[2];
rzz(0.28800000000000003) q[1], q[2];
rxx(0.28800000000000003) q[0], q[1];
rzz(0.28800000000000003) q[0], q[1];
rxx(0.28800000000000003) q[2], q[3];
unitary q[1], q[2];
rzz(0.28800000000000003) q[0], q[1];
rzz(0.28800000000000003) q[2], q[3];
rxx(0.28800000000000003) q[1], q[2];
rxx(0.28800000000000003) q[2], q[3];
rzz(0.28800000000000003) q[1], q[2];
unitary_0 q[0], q[1];
