...
gate rxx(_gate_p_0) _gate_q_0, _gate_q_1 {
  ...
  rz(0.16800000000000004) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  h _gate_q_1;
  h _gate_q_0;
}
...
gate unitary_2 _gate_q_0, _gate_q_1 {
  U(pi, -0.32175055439664213, -0.32175055439664213) _gate_q_0;
  U(0.5613868409134124, pi/2, -pi/2) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(2.469592653589793, 0, pi/2) _gate_q_0;
  U(1.6689355422819956, 1.9103060770429616, -2.1288659056200814) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(0, -2.1519749192642257, -2.560414061120465) _gate_q_0;
...
bit[1] c;
qubit[4] q;
rxx(0.16800000000000004) q[1], q[2];
rzz(0.16800000000000004) q[1], q[2];
rzz(0.16800000000000004) q[1], q[2];
rxx(0.16800000000000004) q[0], q[1];
rzz(0.16800000000000004) q[0], q[1];
rxx(0.16800000000000004) q[2], q[3];
unitary q[1], q[2];
rzz(0.16800000000000004) q[0], q[1];
rzz(0.16800000000000004) q[2], q[3];
rxx(0.16800000000000004) q[1], q[2];
rxx(0.16800000000000004) q[2], q[3];
rzz(0.16800000000000004) q[1], q[2];
unitary_0 q[0], q[1];
