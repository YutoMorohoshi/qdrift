...
gate unitary_0 _gate_q_0, _gate_q_1 {
  ...
  U(1.714165510045859, 1.9745804924582027, -2.2456203269091635) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_2 _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(2.0495926535897935, 0, pi/2) _gate_q_0;
  U(1.8162866379554845, 2.079563481348056, -2.4567982844111746) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_3 _gate_q_0, _gate_q_1 {
  ...
  U(1.9375247218801335, 2.1630684210115785, -2.6630802031421323) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(pi/2, 0, -pi/2) _gate_q_0;
  U(pi/2, -1.0094094858814842, -pi) _gate_q_1;
}
...
gate unitary_5 _gate_q_0, _gate_q_1 {
  ...
  U(0.5613868409134123, pi/2, pi/2) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(2.3225926535897927, 0, pi/2) _gate_q_0;
  U(1.7141655100458584, 1.9745804924582027, -2.2456203269091635) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(0, 1.952819928843132, 2.7595690515415576) _gate_q_0;
  U(1.0094094858814837, -pi/2, -pi/2) _gate_q_1;
}
