...
gate rxx(_gate_p_0) _gate_q_0, _gate_q_1 {
  ...
  rz(0.21000000000000002) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  h _gate_q_1;
  h _gate_q_0;
}
...
gate unitary_0 _gate_q_0, _gate_q_1 {
  ...
  U(1.6574175332390009, 1.8910610668851682, -2.095086098367555) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_2 _gate_q_0, _gate_q_1 {
  ...
  U(1.7212217642270293, 1.9833460694814002, -2.2621143524498315) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_3 _gate_q_0, _gate_q_1 {
  ...
  U(1.7991979729261718, 2.064731630639142, -2.4247248053520067) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(pi/2, 0, -pi/2) _gate_q_0;
...
gate unitary_5 _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(2.5115926535897932, 0, pi/2) _gate_q_0;
  U(1.6574175332390007, 1.8910610668851682, -2.095086098367555) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(0.21000000000000002) q[1], q[2];
rzz(0.21000000000000002) q[1], q[2];
rzz(0.21000000000000002) q[1], q[2];
rxx(0.21000000000000002) q[0], q[1];
rzz(0.21000000000000002) q[0], q[1];
rxx(0.21000000000000002) q[2], q[3];
unitary q[1], q[2];
rzz(0.21000000000000002) q[0], q[1];
rzz(0.21000000000000002) q[2], q[3];
rxx(0.21000000000000002) q[1], q[2];
rxx(0.21000000000000002) q[2], q[3];
rzz(0.21000000000000002) q[1], q[2];
unitary_0 q[0], q[1];
