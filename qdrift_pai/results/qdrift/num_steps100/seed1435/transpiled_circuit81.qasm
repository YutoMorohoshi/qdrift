...
gate rxx(_gate_p_0) _gate_q_0, _gate_q_1 {
  ...
  rz(0.24600000000000002) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  h _gate_q_1;
  h _gate_q_0;
}
...
gate unitary_0 _gate_q_0, _gate_q_1 {
  ...
  U(1.6883194518495097, 1.9397773584075164, -2.1815696728158445) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_2 _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(2.1575926535897936, 0, pi/2) _gate_q_0;
  U(1.773305702673378, 2.0404244947343173, -2.374046255847702) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_3 _gate_q_0, _gate_q_1 {
  ...
  U(pi/2, 0, 2.5802058126763807) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(2.649592653589793, 0, pi/2) _gate_q_0;
  U(1.8755178857167196, 2.124657890738531, -2.5614131069015578) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(pi/2, 0, -pi/2) _gate_q_0;
...
gate unitary_5 _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(2.4035926535897936, 0, pi/2) _gate_q_0;
  U(1.68831945184951, 1.9397773584075164, -2.1815696728158454) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(0.24600000000000002) q[1], q[2];
rzz(0.24600000000000002) q[1], q[2];
rzz(0.24600000000000002) q[1], q[2];
rxx(0.24600000000000002) q[0], q[1];
rzz(0.24600000000000002) q[0], q[1];
rxx(0.24600000000000002) q[2], q[3];
unitary q[1], q[2];
rzz(0.24600000000000002) q[0], q[1];
rzz(0.24600000000000002) q[2], q[3];
rxx(0.24600000000000002) q[1], q[2];
rxx(0.24600000000000002) q[2], q[3];
rzz(0.24600000000000002) q[1], q[2];
unitary_0 q[0], q[1];
