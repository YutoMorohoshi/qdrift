...
gate rxx(_gate_p_0) _gate_q_0, _gate_q_1 {
  ...
  rz(0.08700000000000001) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  h _gate_q_1;
  h _gate_q_0;
}
...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.5776011655601518, 1.6630935010731651, -1.7178814324764602) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_0 _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(3.0545926535897934, 0, pi/2) _gate_q_0;
...
gate unitary_2 _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(2.793592653589793, 0, pi/2) _gate_q_0;
  U(1.5978132559018785, 1.7534208318289002, -1.863752236838729) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_3 _gate_q_0, _gate_q_1 {
  ...
  U(1.612777925432754, 1.797267463864487, -1.9358997737567574) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(pi/2, 0, -pi/2) _gate_q_0;
...
bit[1] c;
qubit[4] q;
rxx(0.08700000000000001) q[1], q[2];
rzz(0.08700000000000001) q[1], q[2];
rzz(0.08700000000000001) q[1], q[2];
rxx(0.08700000000000001) q[0], q[1];
rzz(0.08700000000000001) q[0], q[1];
rxx(0.08700000000000001) q[2], q[3];
unitary q[1], q[2];
rzz(0.08700000000000001) q[0], q[1];
rzz(0.08700000000000001) q[2], q[3];
rxx(0.08700000000000001) q[1], q[2];
rxx(0.08700000000000001) q[2], q[3];
rzz(0.08700000000000001) q[1], q[2];
unitary_0 q[0], q[1];
