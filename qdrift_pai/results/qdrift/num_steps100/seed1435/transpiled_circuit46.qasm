...
gate rxx(_gate_p_0) _gate_q_0, _gate_q_1 {
  ...
  rz(0.14100000000000001) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  h _gate_q_1;
  h _gate_q_0;
}
...
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.5885976861551219, 1.719511208948628, -1.8086362288493314) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_0 _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(3.000592653589793, 0, pi/2) _gate_q_0;
  U(1.610526608930192, 1.7912840112986599, -1.9259859201618994) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
gate unitary_3 _gate_q_0, _gate_q_1 {
  ...
  U(1.6784344556097248, 1.9251624482109087, -2.1552758039200217) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(pi/2, 0, -pi/2) _gate_q_0;
  U(pi/2, -1.0094094858814842, -pi) _gate_q_1;
}
...
gate unitary_5 _gate_q_0, _gate_q_1 {
  ...
  U(0.5613868409134123, pi/2, pi/2) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(2.718592653589793, 0, pi/2) _gate_q_0;
  U(1.610526608930192, 1.7912840112986599, -1.9259859201618994) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rxx(0.14100000000000001) q[1], q[2];
rzz(0.14100000000000001) q[1], q[2];
rzz(0.14100000000000001) q[1], q[2];
rxx(0.14100000000000001) q[0], q[1];
rzz(0.14100000000000001) q[0], q[1];
rxx(0.14100000000000001) q[2], q[3];
unitary q[1], q[2];
rzz(0.14100000000000001) q[0], q[1];
rzz(0.14100000000000001) q[2], q[3];
rxx(0.14100000000000001) q[1], q[2];
rxx(0.14100000000000001) q[2], q[3];
rzz(0.14100000000000001) q[1], q[2];
unitary_0 q[0], q[1];
