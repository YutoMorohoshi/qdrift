...
gate rzz(_gate_p_0) _gate_q_0, _gate_q_1 {
  ...
  rz(0.20999999999999996) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
}
...
bit[1] c;
qubit[4] q;
rzz(0.20999999999999996) q[1], q[2];
unitary q[0], q[1];
rxx(0.20999999999999996) q[2], q[3];
rxx(0.20999999999999996) q[2], q[3];
rzz(0.20999999999999996) q[2], q[3];
rzz(0.20999999999999996) q[1], q[2];
rxx(0.20999999999999996) q[0], q[1];
rzz(0.20999999999999996) q[2], q[3];
rxx(0.20999999999999996) q[2], q[3];
c[0] = measure q[0];
