...
gate rzz(_gate_p_0) _gate_q_0, _gate_q_1 {
  ...
  rz(0.8700000000000001) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
}
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.9549384770550233, 2.172452639191847, -2.690616374836323) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rzz(0.8700000000000001) q[1], q[2];
unitary q[0], q[1];
rxx(0.8700000000000001) q[2], q[3];
rxx(0.8700000000000001) q[2], q[3];
rzz(0.8700000000000001) q[2], q[3];
rzz(0.8700000000000001) q[1], q[2];
rxx(0.8700000000000001) q[0], q[1];
rzz(0.8700000000000001) q[2], q[3];
rxx(0.8700000000000001) q[2], q[3];
c[0] = measure q[0];
