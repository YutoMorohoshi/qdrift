...
gate rzz(_gate_p_0) _gate_q_0, _gate_q_1 {
  ...
  rz(1.3499999999999999) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
}
gate unitary _gate_q_0, _gate_q_1 {
  ...
  U(1.6140399525076892, 1.8005453498688189, -1.941340939780308) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
...
bit[1] c;
qubit[4] q;
rzz(1.3499999999999999) q[1], q[2];
unitary q[0], q[1];
rxx(1.3499999999999999) q[2], q[3];
rxx(1.3499999999999999) q[2], q[3];
rzz(1.3499999999999999) q[2], q[3];
rzz(1.3499999999999999) q[1], q[2];
rxx(1.3499999999999999) q[0], q[1];
rzz(1.3499999999999999) q[2], q[3];
rxx(1.3499999999999999) q[2], q[3];
c[0] = measure q[0];
