...
bit[1] c;
qubit[4] q;
PauliEvolution(0.046) q[0], q[1], q[2], q[3];
PauliEvolution_0(0.046) q[0], q[1], q[2], q[3];
PauliEvolution_1(0.046) q[0], q[1], q[2], q[3];
PauliEvolution_2(0.046) q[0], q[1], q[2], q[3];
PauliEvolution_3(0.046) q[0], q[1], q[2], q[3];
PauliEvolution_4(0.046) q[0], q[1], q[2], q[3];
PauliEvolution_5(0.046) q[0], q[1], q[2], q[3];
PauliEvolution_6(0.046) q[0], q[1], q[2], q[3];
PauliEvolution_7(0.046) q[0], q[1], q[2], q[3];
PauliEvolution_8(0.046) q[0], q[1], q[2], q[3];
c[0] = measure q[0];
