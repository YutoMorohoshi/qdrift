...
gate unitary_37 _gate_q_0, _gate_q_1 {
  ...
  cx _gate_q_0, _gate_q_1;
  U(pi/2, -pi, -pi/4) _gate_q_0;
  U(2.21252155923421, 2.2977102204433235, -2.6523928776916197) _gate_q_1;
}
gate unitary_38 _gate_q_0, _gate_q_1 {
  U(pi, 0, -pi) _gate_q_0;
  U(0.5613868409134123, pi/2, pi/2) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
  U(2.958892653589793, 0, pi/2) _gate_q_0;
  U(1.5782967330332494, 1.6676726174900072, -1.7252133965142953) _gate_q_1;
  cx _gate_q_0, _gate_q_1;
